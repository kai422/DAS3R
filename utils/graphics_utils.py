...
def to_open3d_point_cloud(basic_point_cloud: BasicPointCloud) -> o3d.geometry.PointCloud:
    o3d_pc = o3d.geometry.PointCloud()
    o3d_pc.points = o3d.utility.Vector3dVector(basic_point_cloud.points)
    o3d_pc.colors = o3d.utility.Vector3dVector(basic_point_cloud.colors)
